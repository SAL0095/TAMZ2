...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences settings = getApplicationContext().getSharedPreferences("cityShared", MODE_PRIVATE);
        String cityTemp = settings.getString("cityShared", "");
        if (cityTemp != "")

        {
            EditText e_ = (EditText) findViewById(R.id.editTextCity);
            e_.setText(cityTemp);
        }
    }
    @Override
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.buttonConfirm){
            ...
            editor.clear();
            editor.putString("cityShared", city);
            editor.commit();
